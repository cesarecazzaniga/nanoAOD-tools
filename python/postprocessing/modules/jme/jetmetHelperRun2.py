...
def createJMECorrector(isMC=True,
    ...
    jmrValues_ = jmrValues[dataYear.replace('UL', '')]    #CZZ: temporary FIX - for now values for UL are not yet released
    jmsValues_ = jmsValues[dataYear.replace('UL', '')]                      #CZZ: temporary FIX - for now values for UL are not yet released
